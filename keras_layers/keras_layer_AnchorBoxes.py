...
class AnchorBoxes(Layer):
    ...
    def call(self, x, mask=None):
        ...
        if (self.this_steps is None):
            step_height = self.img_height / feature_map_height.value
            step_width = self.img_width / feature_map_width.value
        else:
        ...
        cy = np.linspace(offset_height * step_height, (offset_height + feature_map_height.value - 1) * step_height, feature_map_height.value)
        cx = np.linspace(offset_width * step_width, (offset_width + feature_map_width.value - 1) * step_width, feature_map_width.value)
